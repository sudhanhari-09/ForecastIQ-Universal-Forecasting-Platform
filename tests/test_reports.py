...
class TestReportPersistence:
    ...
    def test_get_report_context(self, db, sample_dataset):
        from services.report_service import get_report_context
        from unittest.mock import patch
        with patch('services.report_service.generate_full_report',
                   return_value=({'best_model': 'XGB', 'dataset_name': 'test.csv'}, None)):
